...
class PreciosActuales:
    ...
    async def precio_actual_activo(self,tipo="linear", symbols=["BTCUSDT", "ETHUSDT", "SOLUSDT", "XRPUSDT"]):
        import websockets
        import json
        import asyncio
...
#import asyncio
#asyncio.run(PreciosActuales().precio_actual_activo("INVERSE", ["btcusd"]))